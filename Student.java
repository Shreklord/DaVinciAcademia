...
public class Student extends User{
    ...
    public Student(UUID id, String username, String password, String firstName, String lastName, String standing, Major major, double GPA, ArrayList<StudentCourse> courses,  ArrayList<String> notes) {
        ...
        this.setCurrentCourses(currentCourses);         // in order for the super() command to work and change the uml to reflact that. thank u - spencer
=======
        this.setGPA(GPA);
b69d993bbed91e89dc15960bb0f73b2950e838b2
        this.setNotes(notes);
    }
